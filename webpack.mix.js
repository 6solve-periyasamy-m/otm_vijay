...
mix.copy('resources/assets/js/addons', 'public/js')
    ...
    .sass('resources/assets/scss/pdf/kpt-itinerary.scss', 'css/kpt.css')
    ...
    .sass('resources/assets/scss/fontawesome.scss', 'css')
    .postCss('resources/assets/css/tailwind.css', 'public/css', [tailwindcss(),])
    .js('resources/assets/js/app.js', 'js')
    .js('resources/assets/js/booking/simple.js', 'js/booking')
    .js('resources/assets/js/booking/v3.js', 'js/booking')
    .js('resources/assets/js/ckeditor/ckeditor.js', 'js')
    ...
    .copy('resources/assets/external', 'public/external')
