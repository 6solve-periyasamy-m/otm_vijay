...
use App\Http\Controllers\Models\OrdercustomerController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('orders')->group(function () {
        ...
        Route::prefix('{order}')->group(function () {
            ...
            Route::prefix('customer')->group(function () {
                Route::get('/', [OrdercustomerController::class, 'index'])->name('order-customers.all');
                Route::get('/create', [OrdercustomerController::class, 'create'])->name('order-customers.create');
                Route::post('/create', [OrdercustomerController::class, 'store'])->name('order-customers.store');
                Route::prefix('{orderCustomer}')->group(function () {
                    ...
                    Route::get('/update', [OrdercustomerController::class, 'edit'])->name('order-customers.edit');
                    Route::post('/update', [OrdercustomerController::class, 'update'])->name('order-customers.update');
                    Route::post('/delete', [OrdercustomerController::class, 'destroy'])->name('order-customers.delete');
