...
class ModifyCustomerTable extends Migration
{
    ...
    public function down()
    {
        Schema::table('customers', function (Blueprint $table) {
            ...
            // most of these changes do not need to be reverted
            $table->dropColumn(['billing_line_1', 'billing_line_2', 'billing_line_3', 'billing_town', 'billing_country', 'billing_postcode']);
        });
    }
}
