...
class AddItineraryEmailTemplateSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        DB::table('settings')->insert([
            [
                'key' => 'email.itinerary-document.subject',
                'value' => 'Itinerary - [BOOKING_REFERENCE] | [LEAD_FIRST_NAME] [LEAD_LAST_NAME]'
            ],
            [
                'key' => 'email.itinerary-document.template',
...
<p>Please find your Booking Confirmation and Itinerary for your reference. <br></p>
