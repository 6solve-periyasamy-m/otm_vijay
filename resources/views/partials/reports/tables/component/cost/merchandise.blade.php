@php /** @var \App\Models\Order\Component\OrderMerchandise[] $data */ @endphp
<table class="datatable table table-striped report-table">
    ...
    <tr>
        ...
        <th scope="col">Merchandise Currency</th>
        <th scope="col">Merchandise Purchase Price</th>
        <th scope="col">Purchase Price</th>
        <th scope="col">Merchandise Created</th>
