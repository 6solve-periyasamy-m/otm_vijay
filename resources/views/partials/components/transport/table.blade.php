<script type="text/javascript">
    $(document).ready(function () { $('#transportInventory').DataTable({fixedHeader: true}); });
</script>
<a href="{{ route('transport-inventories.create', ['transport' => $transport, ]) }}" class="btn btn-primary">Add Inventory</a>
