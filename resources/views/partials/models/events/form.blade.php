...
@include('partials.fields.date', ['name' => 'Start Date', 'field' => 'starts_at', 'value' => $starts_at ?? null,
'onChange' => 'changeDate($(\'#starts_at-input\'), $(\'#ends_at-input\'))', 'width' => 6,])
@include('partials.fields.date', ['name' => 'End Date', 'field' => 'ends_at', 'value' => $ends_at ?? null,
