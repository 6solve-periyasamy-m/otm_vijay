...
@push('header-ready')
    changeBillingForm();
@endpush
@include('partials.fields.text', ['name' => 'Title', 'field' => 'title', 'value' => $title ?? null, ])
@include('partials.fields.text', ['name' => 'First Name', 'field' => 'first_name', 'value' => $first_name ?? null, 'width' => 4,])
...
@include('partials.fields.text', ['name' => 'Email Address', 'field' => 'email_address', 'value' => $email_address ?? null, ])
...
@include('partials.fields.text', ['name' => 'Home Country', 'field' => 'home_country', 'value' => $home_country ?? null, 'width' => 6,])
...
@include('partials.fields.text', ['name' => 'Billing Country', 'field' => 'billing_country', 'value' => $billing_country ?? null, 'width' => 6, 'divClasses' => 'billing-address',])
...
<hr style="border-bottom: 5px solid #cccccc; border-radius: 2px;"/>
@include('partials.fields.text', ['name' => 'Emergency Contact Name', 'field' => 'emergency_contact_name', 'value' => $emergency_contact_name ?? null, 'width' => 6,])
@include('partials.fields.text', ['name' => 'Emergency Contact Relationship', 'field' => 'emergency_contact_relationship', 'value' => $emergency_contact_relationship ?? null, 'width' => 6,])
@include('partials.fields.text', ['name' => 'Emergency Contact Telephone', 'field' => 'emergency_contact_telephone', 'value' => $emergency_contact_telephone ?? null, 'width' => 6,])
<hr style="border-bottom: 5px solid #cccccc; border-radius: 2px;"/>
@include('partials.fields.text', ['name' => 'Passport First Name', 'field' => 'passport_first_name', 'value' => $passport_first_name ?? null, 'width' => 6,])
@include('partials.fields.text', ['name' => 'Passport Middle Name', 'field' => 'passport_middle_name', 'value' => $passport_middle_name ?? null, 'width' => 6,])
@include('partials.fields.text', ['name' => 'Passport Last Name', 'field' => 'passport_last_name', 'value' => $passport_last_name ?? null, 'width' => 6,])
@include('partials.fields.text', ['name' => 'Passport Number', 'field' => 'passport_number', 'value' => $passport_number ?? null, 'width' => 6,])
@include('partials.fields.date', ['name' => 'Passport Issue Date', 'field' => 'passport_issue_date', 'value' => $passport_issue_date ?? null, 'width' => 6,])
@include('partials.fields.date', ['name' => 'Passport Expiry Date', 'field' => 'passport_expiry_date', 'value' => $passport_expiry_date ?? null, 'width' => 6,])
<hr style="border-bottom: 5px solid #cccccc; border-radius: 2px;"/>
@include('partials.fields.selector.adder', ['name' => 'T-Shirt Size', 'field' => 't_shirt_size_id', 'value' => $t_shirt_size_id ?? 0,
'route' => 't-shirt-size', 'createRoute' => route('t-shirt-sizes.create'), 'width' => 6])
@include('partials.fields.selector.adder', ['name' => 'Hat Size', 'field' => 'hat_size_id', 'value' => $hat_size_id ?? 0,
'route' => 'hat-size', 'createRoute' => route('hat-sizes.create'), 'width' => 6])
<hr style="border-bottom: 5px solid #cccccc; border-radius: 2px;"/>
@include('partials.fields.text', ['name' => 'Loyalty Number', 'field' => 'loyalty_number', 'value' => $loyalty_number ?? null,])
