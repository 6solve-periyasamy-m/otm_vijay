<form action="{{ $action }}" method="post">
    ...
    <div id="form-group">
        ...
        <input name="departure_airport_id" value="{{ $departure_airport_id ?? "" }}" class="form-control"
               id="departure_airport_id-input">
    </div>
    <p></p>
    <div id="form-group">
        <label for="arrival_airport_id-input">Arrival Airport Id</label>
        <input name="arrival_airport_id" value="{{ $arrival_airport_id ?? "" }}" class="form-control"
               id="arrival_airport_id-input">
    </div>
    <p></p>
    <div id="form-group">
