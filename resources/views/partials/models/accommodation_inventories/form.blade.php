<form action="{{ $action }}" method="post">
  ...
  <div id="form-group">
    ...
    <input name="accommodation_id" value="{{ $accommodation_id ?? "" }}" class="form-control" id="accommodation_id-input">
  </div><p></p>
  <div id="form-group">
  ...
  <div id="form-group">
    ...
    <input name="checkin_confirmed" type="checkbox" value="{{ $checkin_confirmed ?? "" }}" class="form-control" id="checkin_confirmed-input">
  </div><p></p>
  <div id="form-group">
    <label for="check_out_date_time-input">Check Out Date Time</label>
    <input name="check_out_date_time" type="date" value="{{ $check_out_date_time ?? "" }}" class="form-control" id="check_out_date_time-input">
  </div><p></p>
  <div id="form-group">
    <label for="checkout_confirmed-input">Checkout Confirmed</label>
    <input name="checkout_confirmed" type="checkbox" value="{{ $checkout_confirmed ?? "" }}" class="form-control" id="checkout_confirmed-input">
  </div><p></p>
  <div id="form-group">
