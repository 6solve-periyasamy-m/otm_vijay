@include('partials.fields.selector.adder', ['name' => 'Travel Class', 'field' => 'travel_class_id', 'value' => $travel_class_id ?? 0,
...
@include('partials.fields.datetime', ['name' => 'Departs At', 'field' => 'departs_at', 'value' => $departs_at ?? null,
'onChange' => 'changeDate($(\'#departs_at-input\'), $(\'#arrives_at-input\'))', 'width' => 6,])
@include('partials.fields.datetime', ['name' => 'Arrives At', 'field' => 'arrives_at', 'value' => $arrives_at ?? null,
