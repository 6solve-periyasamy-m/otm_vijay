...
@include('partials.models.addresses.selector', ['prefix' => 'departure_', 'value' => $departure_address_id,])
@include('partials.models.addresses.selector', ['prefix' => 'arrival_', 'value' => $arrival_address_id,])
