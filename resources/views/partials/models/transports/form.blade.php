<form action="{{ $action }}" method="post">
  ...
  <div id="form-group">
    ...
    <input name="transport_type_id" value="{{ $transport_type_id ?? "" }}" class="form-control" id="transport_type_id-input">
  </div><p></p>
  <div id="form-group">
  ...
  <div id="form-group">
    ...
    <input name="departure_location_id" value="{{ $departure_location_id ?? "" }}" class="form-control" id="departure_location_id-input">
  </div><p></p>
  <div id="form-group">
    <label for="arrival_location_id-input">Arrival Location Id</label>
    <input name="arrival_location_id" value="{{ $arrival_location_id ?? "" }}" class="form-control" id="arrival_location_id-input">
  </div><p></p>
  <div id="form-group">
