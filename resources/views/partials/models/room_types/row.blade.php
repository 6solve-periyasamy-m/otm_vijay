<tr>
  ...
  <td>
    <a href="{{route('room-types.edit', ['roomType' => $roomType,])}}"><ion-icon name="create"></ion-icon></a>
    ...
    <form id="roomType-{{ $roomType->id }}-delete" action="{{ route('room-types.delete', ['roomType' => $roomType,]) }}" method="POST" style="display: none;">{{ csrf_field() }}</form>
  </td>
</tr>
