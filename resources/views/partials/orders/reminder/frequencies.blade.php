<x-admin.section.card>
    <div class="row">
        ...
        <div class="form-group col-12 col-xl-2">
            <a class="form-control mx-auto btn btn-block btn-primary text-white" href="{{ route($route, ['max' => 0, 'min' => -1]) }}">Today</a>
        </div>
        <div class="form-group col-12 col-xl-2">
            <a class="form-control mx-auto btn btn-block btn-primary text-white" href="{{ route($route, ['max' => -1, 'min' => -7]) }}">1 Day Overdue</a>
        </div>
        <div class="form-group col-12 col-xl-2">
            <a class="form-control mx-auto btn btn-block btn-primary text-white" href="{{ route($route, ['max' => -7, 'min' => -14]) }}">7 Days Overdue</a>
        </div>
        <div class="form-group col-12 col-xl-2">
...
@push('footer-stack')
    <script type="text/javascript">
        function showNewRange() {
            ...
            window.location = '{{ route($route) }}/' + max + '/' + min;
        }
    </script>
@endpush
