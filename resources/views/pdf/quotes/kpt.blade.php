                        ...
                        <table align="left" width="100%" border="0" cellspacing="0">
                            <tr>
                                <td align="left" valign="top" style="padding: 0 20px;">
                                    <img src="{{ img_to_b64($brand->image_path) }}" alt="{{ $brand->name }}"
                                         width="100%" style="display: block; max-width: 160px">
                                </td>
                            </tr>
                        </table>
                    </td>
                        ...
                        <table align="left" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td width="120" align="left" valign="top"
                                    style="padding: 10px 15px 0px 25px; line-height:10px;" class="oc_f12">
                                    &nbsp;
                                </td>
                            ...
                            <tr>
                                <td align="left" valign="top">
                                    <img src="{{img_to_b64($evenImg)}}"
                                         alt="{{ isset($quote->event->name) ? $quote->event->name : '' }}" width="100%"
            ...
            <table align="left" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td align="left" valign="top" style="padding: 10px 15px 0px 25px; line-height:10px;"
                        class="oc_f12 oc_lblack">
                        {{ \Carbon\Carbon::parse($quote->date_from)->format('d F Y') }}
                        - {{ \Carbon\Carbon::parse($quote->date_to)->format('d F Y') }}
                    </td>
                </tr>
                <tr>
                    <td align="left" width="75" valign="top"
...
@if(sizeof($quote->flights))
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff" class="full-wrap">
        @foreach($quote->repository->getTransportForInvoice() as $component)
            ...
            <tr>
                <td align="left" width="80" valign="top"
                    style="padding: 2px 10px 2px 40px; font-weight: bold; line-height: 10px;" class="oc_f12 oc_lblack">
                    DATE:
                </td>
            ...
            <tr>
                <td align="left" width="80" valign="top"
                    style="padding: 2px 10px 10px 40px; font-weight: bold; line-height: 10px;" class="oc_f12 oc_lblack">
                    QUANTITY:
                </td>
                <td align="left" valign="top" style="padding: 0px 40px; line-height: 10px;" class="oc_f12 oc_lblack">
                    {{ $paying + $travelling }}
...
<table width="105%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff" class="full-wrap">
    ...
    @if($quote->deposit > 0 || sizeof($quote->installments))
        <tr>
            <td align="left" valign="top" class="oc_f16"
                ...
                <table align="left" border="0" cellspacing="0" cellpadding="0" class="paymentTable" width="100%">
                    ...
                    <tr style="background-color: #353535;">
                        <th width="25%" align="left" valign="top"
                            style="padding: 2px 15px; font-weight: bold; color: #ffffff;" class="oc_f16">
                            INSTALMENTS
                        </th>
                        <th width="25%" align="left" valign="top"
                            style="padding: 2px 15px; font-weight: bold; color: #ffffff;" class="oc_f16">
