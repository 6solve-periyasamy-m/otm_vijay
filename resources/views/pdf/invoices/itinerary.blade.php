...
<body class="body"
      style="padding:0; margin:0 auto !important; display:block !important; width:100% !important; background:#ffffff; -webkit-text-size-adjust:none">
<table style="width: 100%;" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff"
       style="background-color:#ffffff; padding: 35px 0;" class="full-wrap">
    <tr>
                        ...
                        <table width="100%" align="center" border="0" cellspacing="0"
                            ...
                            <tr>
                                <td align="center" valign="center" class="oc_black"
                                    style="border-radius: 30px; padding: 20px 10px; font-weight: normal; background-color: #ffffff; color: #E95B15; margin: 0 auto; outline: 2px solid #E95B15; font-size: 15pt; min-width: 200px; max-width: 180px; display: block;">
                                    TRAVEL ITINERARY
                                </td>
                            </tr>
                        </table>
                        ...
                        <table align="left" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td colspan="2" align="left" valign="top"
                                    style="padding: 10px 15px 2px 25px; line-height: 14px; color: #ffffff; line-height: 20px;"
                                    class="oc_f16">
                            ...
                            @foreach($order->orderCustomers as $ordersCustomer)
                                <tr>
                                    <td align="left" valign="top"
                                        style="padding: 10px 15px 0px 25px; color: #ffffff; line-height:20px;"
                                        class="oc_f14">
                            ...
                            <tr>
                                ...
                                <td class="oc_f14"
                                    style="padding: 10px 15px 0px 25px; color: #ffffff; line-height:10px;">
            ...
            <table align="left" width="100%" cellspacing="0" cellpadding="0">
                ...
                <tr style=" background-color: #353535;">
                    <th align="left" valign="top" style="padding: 10px 25px; color: #ffffff; font-weight: 700;"
                        class="oc_f16 ">TRIP ITINERARY AND INCLUSIONS
                    </th>
                </tr>
                </thead>
            </table>
        ...
        <tr>
            <td colspan="2" align="left">
                <div style="background-color: #E95B15; border-radius: 0 30px 30px 0; max-width: 190px; padding: 10px 25px; margin: 10px 0; color: #ffffff; display: block;"
                     class="oc_f16 oc_lblack " id="day_heading_{{ $loop->iteration }}">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff"
    ...
    @foreach($tour->flightInventoryTours as $tourComponent)
        ...
        @if($date->format('Y-m-d') >= $arrives_at->format('Y-m-d') && $date->format('Y-m-d') <= $departs_at->format('Y-m-d'))
            ...
            <tr>
                <td align="left" colspan="2" style="padding: 0px 40px; color: #E95B15; font-size: 11pt;"
                    class="oc_f16 ">TRANSFER
                </td>
            </tr>
            <tr>
    ...
    @foreach($tour->accommodationInventoryTours as $tourComponent)
        @if($date->format('Y-m-d') >= date('Y-m-d', strtotime($tourComponent->inventory->check_in)) && $date->format('Y-m-d') <= date('Y-m-d', strtotime($tourComponent->inventory->check_out)))
            ...
            <tr>
                <td align="left" width="50" valign="top" style="padding: 10px 40px; background-color: #ffffff;"
                    class="oc_f12 oc_lblack">Hotel:
                </td>
                <td align="left" valign="top"
                    style="padding: 10px 40px; background-color: #ffffff;" class="oc_f12 oc_lblack">
                    {{ $tourComponent->inventory->component->name }}
                </td>
            </tr>
            @if($is_accommodation == 1)
                <tr>
                    <td align="left" width="50" valign="top" style="padding: 0px 40px;" class="oc_f12 oc_lblack">No Of
                        Nights:
                    </td>
                ...
                <tr>
                    <td align="left" width="50" valign="top" style="padding: 0px 40px;" class="oc_f12 oc_lblack">Check
                        In Date:
                    </td>
                    <td align="left" valign="top" style="padding: 0px 40px;" class="oc_f12 oc_lblack">
                ...
                <tr>
                    <td align="left" width="50" valign="top" style="padding: 0px 40px;">&nbsp;
                    </td>
                    <td align="left" valign="top" style="padding: 0px 40px;">
                        &nbsp;
                    </td>
                ...
                <tr>
                    <td align="left" width="50" valign="top" style="padding: 0px 40px;" class="oc_f12 oc_lblack">Hotel
                        Description:
                    </td>
                    <td align="left" valign="top" style="padding: 0px 40px;" class="oc_f12 oc_lblack">
    ...
    @foreach($tour->activityInventoryTours as $tourComponent)
        ...
        @if($date->format('Y-m-d') >= $startDateTime->format('Y-m-d') && $date->format('Y-m-d') <= $endDateTime->format('Y-m-d'))
            ...
            <tr>
                <td align="left" width="40" valign="top" style="padding: 0px 40px;" class="oc_f12 oc_lblack">Ticket
                    Type/s:
                </td>
                <td align="left" valign="top" style="padding: 0px 40px;" class="oc_f12 oc_lblack">
    ...
    <tr>
        <td align="left" colspan="2" width="100%" style="padding: 0px 40px; font-weight: bold; font-size: 11pt;"
...
<div style="padding: 10px 15px 0px 25px;">
    <p class="oc_f12 oc_lblack">{!! $tour->terms !!}</p>
</div>

<div style="padding: 10px 15px 0px 25px;">
    <p class="oc_f12 oc_lblack">{!! $tour->invoice_footer !!}</p>
</div>
