<div class="card">
    <div class="card-body">
        ...
        <div class="row">
            ...
            <x-livewire.input.checkbox wire:model="voucher.active" width="6" label="{{__('voucher.form.fields.active')}}" />
            <x-livewire.input.checkbox wire:model="voucher.global" width="6" label="{{__('voucher.form.fields.global')}}" />
