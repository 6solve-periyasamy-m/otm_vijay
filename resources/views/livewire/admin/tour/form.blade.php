...
<div class="row">
    ...
    <div class="col-xl-4">
        <x-admin.section.card>
            <div class="row">
                <x-livewire.input key="tour.base_price_per_person" wire:model.defer.300ms="tour.base_price_per_person" label="Price per Person" required type="number" step="0.01" />
