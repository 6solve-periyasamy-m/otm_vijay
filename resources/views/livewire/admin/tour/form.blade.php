...
<div class="row">
    <div class="col-xl-12">
        <x-admin.section.card>
            <div class="row">
                ...
                <x-livewire.input.select.brand name="tour.brand_id" label="Brand" value="{{ $tour?->brand_id ?? -1 }}" width="2" />
    ...
    <div class="col-xl-4">
        <x-admin.section.card>
            <div class="row">
                <x-livewire.input wire:model="tour.base_price_per_person" label="Price per Person" />
