...
<style>
   .email-content-container { scrollbar-width: thin; scrollbar-color: #cbd5e1 #f1f5f9; } 
   .email-content-container::-webkit-scrollbar { width: 6px; } 
   .email-content-container::-webkit-scrollbar-track { background: #f1f5f9; border-radius: 3px; } 
   .email-content-container::-webkit-scrollbar-thumb { background: #cbd5e1; border-radius: 3px; } 
   .email-content-container::-webkit-scrollbar-thumb:hover { background: #94a3b8; } 
   .prose { max-width: none; line-height: 1.6; } 
   .prose p { margin-bottom: 0.75rem; } 
   .prose:last-child { margin-bottom: 0; } 
   .truncate { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; } 
   .email-content-container img { max-width: 100%; height: auto; } 
   .email-content-container table { width: 100% !important; border-collapse: collapse; } 
   .email-content-container table, .email-content-container th, .email-content-container td { border: 1px solid #e5e7eb; padding: 0.5rem; } 
   .w-full-70 {width: 70%;} .truncate { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; } 
