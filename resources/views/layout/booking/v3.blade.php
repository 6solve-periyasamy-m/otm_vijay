...
<head>
    ...
    <style>
        ...
        .top-form-contain .email-quote input{width:82%;height:46px;border:2px solid #aaa;outline:0;font-size:14px;line-height:14px;padding-block:0px;padding-inline:0px;border-radius:50px;padding:0 24px;margin-bottom:12px}
