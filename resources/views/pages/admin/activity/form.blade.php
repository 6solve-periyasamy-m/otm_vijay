...
@section('form-body')
    ...
    @include('partials.fields.text', ['name' => 'Ticket Type', 'field' => 'ticket_type', 'value' => $activity?->ticket_type,'width' => 6,])
    @include('partials.fields.text', ['name' => 'Name of game', 'field' => 'game_name', 'value' => $activity?->game_name,'width' => 6,])
