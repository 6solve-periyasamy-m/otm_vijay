...
@section('form-body')
    ...
    <hr class="splitter">
    <x-admin.input name="sales_price" width="6" value="{{$quoteComponent->getSalesPrice()}}">Sales Price</x-admin.input>
    <x-admin.input.checkbox name="shown" width="6" value="{{$quoteComponent->priceShown()}}">Show Price On Quote?</x-admin.input.checkbox>
    <hr class="splitter">
