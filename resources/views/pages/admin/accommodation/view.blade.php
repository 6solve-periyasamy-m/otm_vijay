...
@section('inventory')
    <x-admin.section.card>
        <div class="row">
            ...
            <div class="col-2">
                @if(Gate::check('self-child-access', [$accommodation, \App\Models\Accommodation\AccommodationInventory::class]) || Gate::check('create', AccommodationInventory::class))
            ...
            @foreach($accommodation->inventory as $inventory)
                <tr>
                    ...
                    <td class="actions-4">
                        ...
                        @else
                            <span class="btn btn-outline-dark btn-sm mb-1" title="List">
                                {{ Icon::list() }}
                            </span>
                        @endcan
