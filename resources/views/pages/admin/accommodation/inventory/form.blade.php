...
@section('form-body')
    ...
    <div class="form-group col-xl-6">
        @include('partials.fields.raw.datetime',
                    ['name' => 'Check In', 'field' => 'check_in', 'value' => (isset($accommodation?->check_in)) ? $accommodation?->check_in : $inventory?->check_in,
    ...
    <div class="form-group col-xl-6">
        @include('partials.fields.raw.datetime',
                    ['name' => 'Check Out', 'field' => 'check_out', 'value' => (isset($accommodation?->check_out)) ? $accommodation?->check_out : $inventory?->check_out,
