...
@section('form-body')
    ...
    <div class="form-group col-xl-6">
        @include('partials.fields.raw.dropdown', ['name' => 'Event Category', 'field' => 'event_category','selected' => $event?->event_category, 'values' => \App\Models\Helper\Enum\EventType::toArray(),])
    </div>
