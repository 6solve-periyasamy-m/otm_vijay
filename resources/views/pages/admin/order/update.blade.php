...
@section('form-body')
    ...
    <x-livewire.input.select.organization name="organization_id" value="{{ $order?->organization_id }}" label="Organization (Optional)" width="4" />
    <x-livewire.input.select.tax-bracket name="tax_bracket_id" value="{{ $order?->tax_bracket_id }}" label="Tax Bracket" width="4" />
