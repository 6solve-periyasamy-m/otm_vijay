...
@section('form-body')
    ...
    @include('partials.fields.dropdown', ['name' => 'Status Override', 'field' => 'status_override', 'width' => 3, 'null' => true, 'values' => \App\Models\Helper\Enum\OrderStatus::asArray(), 'selected' => $order?->status_override?->value])
    <x-livewire.input.select.tax-bracket name="tax_bracket_id" value="{{ $order?->tax_bracket_id }}" label="Tax Bracket" width="3"/>
