                ...
                <div class="card">
                    <div class="card-body">
                        <form class="form-horizontal form-material mx-2 row"
                            ...
                            <x-customer.input name="title" value="{{ $customer->title ?? '' }}"
                                              width="2" autocomplete="honorific-prefix">
                                Title
                            </x-customer.input>
                            <x-customer.input name="first_name" value="{{ $customer->first_name ?? '' }}"
                                              width="3" autocomplete="given-name">
                                First Name
                            </x-customer.input>
                            <x-customer.input name="middle_names" value="{{ $customer->middle_names ?? '' }}"
                                              width="3" autocomplete="additional-name">Middle Names
                            </x-customer.input>
                            <x-customer.input name="last_name" value="{{ $customer->last_name ?? '' }}"
                                              width="4" autocomplete="family-name">Last Name
                            </x-customer.input>
                            ...
                            <x-customer.input name="mobile_number" value="{{ $customer->mobile_number ?? '' }}"
                            ...
                            <hr class="splitter">
                            <div class="col-md-6">
                                <div class="form-group"><h4 class="mb-0">Home Address</h4></div>
                                <hr class="splitter">
                                ...
                                <x-customer.input name="home_town" value="{{ $customer->homeAddress->town ?? '' }}"
                                                  autocomplete="address-level2">
                                    Town
                                </x-customer.input>
                                <x-customer.input name="home_town" value="{{ $customer->homeAddress->region ?? '' }}"
