            ...
            <div class="col-lg-3 col-xxl-2 col-md-4">
                ...
                @if(\App\Repository\Authentication\CustomerAuthenticationRepository::getCustomer()->id !== $customer->id)
                    <div class="card other-profile" onclick="window.location = '{{ route('customer.edit') }}';">
                        <div class="card-body profile-card">
                            <center class="mt-4">
                                <h4 class="card-title mt-2">{{ \App\Repository\Authentication\CustomerAuthenticationRepository::getCustomer()->first_name }} {{ \App\Repository\Authentication\CustomerAuthenticationRepository::getCustomer()->last_name }}</h4>
                                <h6 class="card-subtitle">{{ \App\Repository\Authentication\CustomerAuthenticationRepository::getCustomer()->email_address }}</h6>
                            </center>
                        </div>
                    </div>
                @endif
