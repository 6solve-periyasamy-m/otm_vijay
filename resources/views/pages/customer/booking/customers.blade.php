...
<form class="form-horizontal form-material mx-2 row" method="post" action="{{ route('customer-booking.store-customers', ['bookingUrl' => $tour->booking_form_url,]) }}">
    ...
    <div class="card">
        ...
        <div class="form-group col-md-4">
            ...
            <div class="col-md-12">
                <input type="text" name="lead_middle_names" id="lead_middle_names-input" value="{{ $customer?->middle_names ?? '' }}"
        ...
        <div class="col-6">
            ...
            <div class="form-group col-md-12">
                ...
                <div class="col-md-12">
                    <input type="text" name="lead_home_address_line_2" id="lead_home_address_line_2-input" value="{{ $customer->homeAddress->address_line_2 ?? '' }}"
            ...
            <div class="form-group col-md-12">
                ...
                <div class="col-md-12">
                    <input type="text" name="lead_home_town" id="lead_home_town-input" value="{{ $customer->homeAddress->town ?? '' }}"
            ...
            <div class="form-group col-md-12">
                ...
                <div class="col-md-12">
                    <input type="text" name="lead_region" id="lead_region-input" value="{{ $customer->homeAddress->region ?? '' }}"
                           class="form-control ps-0 form-control-line" autocomplete="address-level1">
                </div>
            </div>
            @include('partials.fields.selector.default', ['name' => 'Country', 'field' => 'lead_home_country', 'value' => $customer->homeAddress->country_id ?? null, 'route' => 'countries',])
            <div class="form-group col-md-12">
        ...
        <div class="col-6">
            ...
            <div class="form-group col-md-12">
                <label class="col-md-12 mb-0">Address Line 2</label>
                <div class="col-md-12">
                    <input type="text" name="lead_billing_address_line_2" id="lead_billing_address_line_2-input" value="{{ $customer->billingAddress->address_line_2 ?? '' }}"
                           class="form-control ps-0 form-control-line" autocomplete="address-line2">
                </div>
            </div>
            <div class="form-group col-md-12">
                <label class="col-md-12 mb-0">Town</label>
                <div class="col-md-12">
                    <input type="text" name="lead_billing_town" id="lead_billing_town-input" value="{{ $customer->billingAddress->town ?? '' }}"
                           class="form-control ps-0 form-control-line" autocomplete="address-level2">
                </div>
            </div>
            <div class="form-group col-md-12">
                <label class="col-md-12 mb-0">Region</label>
                <div class="col-md-12">
                    <input type="text" name="lead_region" id="lead_region-input" value="{{ $customer->billingAddress->region ?? '' }}"
                           class="form-control ps-0 form-control-line" autocomplete="address-level1">
                </div>
            </div>
            @include('partials.fields.selector.default', ['name' => 'Country', 'field' => 'lead_billing_country', 'value' => $customer->billingAddress->country_id ?? null, 'route' => 'countries',])
            <div class="form-group col-md-12">
                <label class="col-md-12 mb-0">Postcode</label>
                <div class="col-md-12">
