    ...
    <div class="card">
        <div class="card-body col-12">
            ...
            <div class="col-12" style="margin: 10px;">
                ...
                <a href="#" class="btn btn-danger btn-round text-dark" onclick="reset()">Reset</a>
                <a href="#" class="btn btn-warning btn-round text-dark" onclick="addGroup()">Add Room</a>
                <a href="#" class="btn btn-success btn-round text-dark" onclick="submit()">Save</a>
                <a href="{{ route('customer-booking.summary', $urlParams) }}" class="btn btn-info btn-round text-dark">Return to Booking</a>
            </div>
...
@push('footer-stack')
    <script type="text/javascript">
        ...
        window.date = null;
        function initialize() {
            occupancy.generate('{{ route('api.booking.rooming.get', $urlParams) }}', {}).then((rooming) => {
                data = rooming;
                loadData(true);
                setupDragDrop();
            });
        ...
        function submit() {
            showSpinner();
            data.save('{{ route('api.booking.rooming.save', $urlParams) }}', {}).then((success) => {
                hideSpinner();
                if (success) {
