...
@php $xlsxAbandonedExport = route('reports.abandoned-bookings.export', ['extension' => 'xlsx']); @endphp
    <div class="row">
            ...
            <x-admin.section.card>
                <x-slot:title>
                    <div class="flex justify-between items-center">
                        ...
                        <div class="text-right">
                            <a class="btn btn-success float-end" style="margin-left: 5px;" href="{{ $xlsxAbandonedExport }}">
                                {{ Icon::create() }}
                                <span>Export as Excel</span>
                            </a>
                        </div>
