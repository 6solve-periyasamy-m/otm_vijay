                                ...
                                <tr>
                                    ...
                                    <td class="actions">
                                        @can('update', \App\Models\Transport\TransportInventoryTour::class)
                                            <a href="{{ route('transport-upgrade.edit', ['tour' => $tour, 'inventoryTour' => $inventoryTour,'upgrade'=>$upgrade]) }}" class="btn btn-outline-primary btn-sm mb-1"><x-icon icon="note" /></a>
                                        @else
                                        ...
                                        @can('delete', \App\Models\Transport\TransportInventoryTour::class)
                                            <a href="#" onclick="$('#transport-{{$upgrade->upgrade->id}}-delete').submit()" class="btn btn-outline-danger btn-sm mb-1"><x-icon icon="trash" /></a>
