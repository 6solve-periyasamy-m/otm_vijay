...
@section('content')
<a class="btn btn-primary" href="{{ route('transport-inventory-tours.create') }}">Create New</a><table id="transportInventoryTour" style="width: 100%;" class="table table-striped">
