                    ...
                    <div class="col-12 d-flex">
                        ...
                        <h6 class="fw-bold">{{ $customer->emergency_contact_name }} ({{
                            $customer->emergency_contact_relationship }}), <a
                                href="tel:{{ $customer->emergency_contact_telephone }}">{{
                                $customer->emergency_contact_telephone }}</a></h6>
                    </div>
                    @if($customer->consultant?->name)
    ...
    <div class="col-xl-6 col-md-6 col-12">
        <x-admin.section.card>
            ...
            <table class="datatable table table-striped order-table">
                ...
                <tr>
                    <th scope="row"><a href="{{ route('orders.view', ['order' => $orderCustomer->order,]) }}">{{
                            $orderCustomer->order->booking_reference }}</a></th>
    ...
    <div class="col-xl-6 col-md-6 col-12">
        <x-admin.section.card>
            ...
            <table class="datatable table table-striped order-table">
                ...
                <tr>
                    <th scope="row"><a href="{{ route('quotes.view', ['quote' => $prospect->quote,]) }}">{{
                            $prospect->quote->ref }}</a></th>
