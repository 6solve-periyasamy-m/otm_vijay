...
@section('content')
    @include('partials.models.order_customer_adjustments.form', ['action' => route('order-customer-adjustments.update', ['orderCustomerAdjustment' => $orderCustomerAdjustment,]),
