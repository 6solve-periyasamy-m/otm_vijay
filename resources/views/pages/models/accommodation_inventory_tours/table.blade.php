...
@section('content')
<a class="btn btn-primary" href="{{ route('accommodation-inventory-tours.create') }}">Create New</a><table id="accommodationInventoryTour" style="width: 100%;" class="table table-striped">
