...
class OrderReport extends TourReport
{
    ...
    public function allColumns(): array
    {
        return [
            ...
            'order_commission_percentage' => new ColumnDefinition('reports.order.column.commission.percentage', NumberColumn::callback(['orders.commission',], function ($commission) { return (empty($commission) ? 'Not Set' : $commission . "%"); })),
