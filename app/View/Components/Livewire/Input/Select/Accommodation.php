...
use App\Models\Accommodation\Accommodation as DataModel;
...
class Accommodation extends AbstractSelectComponent
{
    /**
    ...
    {
        return view('components.livewire.input.select.generic', ['route' => 'accommodation']);
    }
