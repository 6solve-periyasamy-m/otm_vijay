...
use App\Models\Customer\HatSize as DataModel;
...
class HatSize extends AbstractSelectComponent
{
    /**
    ...
    {
        return view('components.livewire.input.select.generic', ['route' => 'hat-size',]);
    }
