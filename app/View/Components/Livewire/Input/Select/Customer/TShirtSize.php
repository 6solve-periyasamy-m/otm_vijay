...
use App\Models\Customer\TShirtSize as DataModel;
...
class TShirtSize extends AbstractSelectComponent
{
    /**
    ...
    {
        return view('components.livewire.input.select.generic', ['route' => 't-shirt-size',]);
    }
