...
use App\Models\Location\Currency as DataModel;
...
class Currency extends AbstractSelectComponent
{
    /**
    ...
    {
        return view('components.livewire.input.select.generic', ['route' => 'currencies']);
    }
    ...
    {
        return "{$model->name} - {$model->code} " . ($model->priority ? '*' : '');
    }
}
