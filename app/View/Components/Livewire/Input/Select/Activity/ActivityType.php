...
use App\Models\Activity\ActivityType as DataModel;
...
class ActivityType extends AbstractSelectComponent
{
    /**
    ...
    {
        return view('components.livewire.input.select.activity.activity-type');
    }
