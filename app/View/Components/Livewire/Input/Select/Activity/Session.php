...
use App\Models\Activity\Session as DataModel;
...
class Session extends AbstractSelectComponent
{
    /**
    ...
    {
        return view('components.livewire.input.select.activity.session');
    }
