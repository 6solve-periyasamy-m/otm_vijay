...
use App\Models\Accommodation\RoomType as DataModel;
...
class RoomType extends AbstractSelectComponent
{
    /**
    ...
    {
        return view('components.livewire.input.select.accommodation.room-type');
    }
    ...
    {
        return "$model->name (Size: {$model->maximum_occupancy})";
    }
}
