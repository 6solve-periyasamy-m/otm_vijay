...
class TourRepository
{
    ...
    public static function getAvailableFlightForUpgrades(FlightInventoryTour $tourInventory): array
    {
        $tour = $tourInventory->tour;
        $included = [];
        foreach ($tour->flightInventoryTours as $inventoryTour) {
    ...
    public static function getAvailableTransportForUpgrades(TransportInventoryTour $tourInventory): array
    {
        $tour = $tourInventory->tour;
        $included = [];
        foreach ($tour->transportInventoryTours as $inventoryTour) {
