...
class ComponentInformation
{
     ...
     */
    public function __construct(string $name, string|null $description, string|null $image, Carbon|null $start, Carbon|null $end, View|string|Closure $icon, string $upgrade_name = "", array $attributes = [])
    {
        $this->name = $name;
