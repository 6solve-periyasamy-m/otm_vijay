...
class ShortCodeRepository
{
    ...
    public static function getOrderShortCodes(Order $order = null): array
    {
        ...
        $data = [
            ...
            'DUE_PAYMENT_TOTAL' => Formatter::formatCurrency(isset($order) ? $nextPayment?->calculated_amount : $faker->numberBetween(100, 1000)),
            'DUE_PAYMENT_REMAINING' => Formatter::formatCurrency(isset($order) ? $nextPayment?->remaining : $faker->numberBetween(100, 1000)),
