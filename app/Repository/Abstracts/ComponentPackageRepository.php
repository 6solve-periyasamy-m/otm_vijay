...
abstract class ComponentPackageRepository extends ModelRepository
{
     ...
     * @return InventoryContainerRepository[]
     */
    public abstract function getComponents(bool $accommodation = true,
                                           bool $activities = true,
                                           bool $flights = true,
                                           bool $transport = true,
                                           bool $merchandise = true,
                                           array $filter = ['Included', 'Add-on', 'Upgrade']): array;
