    ...
    * @return FlightInventory|null
    ...
    public function model(array $row)
    {
        ...
        return new FlightInventory([
            ...
            'travel_class_id' => TravelClass::firstOrCreate(trim($row[7])),
            'check_in' => Carbon::parse(trim($row[8])),
            'departs_at' => Carbon::parse(trim($row[9])),
            'arrives_at' => Carbon::parse(trim($row[10])),
