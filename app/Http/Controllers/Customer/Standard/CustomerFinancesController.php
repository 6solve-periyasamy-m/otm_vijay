...
namespace App\Http\Controllers\Customer\Standard;
...
class CustomerFinancesController extends CustomerController
{
    ...
    {
        return view('pages.customer.standard.finances', ['orders' => $this->user()?->orders()->orderBy('cancelled', 'asc')->orderBy('ordered_on', 'desc')->get() ]);
    }
