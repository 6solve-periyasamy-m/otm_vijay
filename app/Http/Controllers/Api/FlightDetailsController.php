...
class OLD_COD_BOOKING {
    ...
    /**
     * DEPRECATE findCustomerOrderDetailByIntentoryTourId
     * COD
     *
     * @param [type] $orders_customer_id
     * @param [type] $inventory_tour_id
    ...
    private function findCustomerOrderDetailByInventoryTourId($orders_customer_id, $inventory_tour_id, $flight_type, $reference, $addon)
    {
        ...
        $customer_order_detail = $model
            ...
            ->join('tours', 'flight_inventory_tours.tour_id', 'tours.id')
    ...
    {
        Log::debug('storeOrUpdateCustomerOrderDetail DEPRECATE!');
