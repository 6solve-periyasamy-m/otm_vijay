...
class BookingCustomerRequest extends FormRequest
{
    ...
    public function getLeadTravellerDetails(): array
    {
        ...
        return [
            ...
            'home_country_id' => $this->lead_home_country,
            ...
            'billing_country_id' => $hib ? $this->lead_home_country : $this->lead_billing_country,
    ...
    public function rules(): array
    {
        return [
            ...
            'lead_billing_address_line_1' => 'required_unless:home_is_billing,on',
            'lead_billing_country' => 'required_unless:home_is_billing,on|exists:countries,id',
            'lead_billing_postcode' => 'required_unless:home_is_billing,on',
