...
class AnonymizeCustomers extends Command
{
    ...
    public function handle()
    {
        ...
        // Matches if either within the /var/www/octopustravelmatrix/, a home directory (all non-production servers), or running on a windows machine (My Dev Environment)
        if (!(str_starts_with(dirname(__FILE__), '/var/www/octopustravelmatrix/')
            || str_starts_with(dirname(__FILE__), '/home/')
