 ...
 * @property int|null $large_text_template_id
 * @property Carbon|null $created_at
 * @property Carbon|null $updated_at
 * @property-read Collection<int, QuoteSection> $sections
 * @property-read int|null $sections_count
 * @property-read LargeTextTemplate|null $template
...
class QuoteSectionType extends SimpleModel
{
    ...
    {
        return $this->belongsTo(LargeTextTemplate::class, 'large_text_template_id');
    }
}
