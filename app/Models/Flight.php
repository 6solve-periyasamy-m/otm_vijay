...
class Flight extends Model
{
    ...
    public function getFlightDetailsAttribute()
    {
        ...
        return "{$this->airline->airline_name} | Departs from: {$this->departureAirport->location->name} - Arrives at: {$this->arrivalAirport->location->name}";
        //return "{$this->airline->airline_name} | Departs {$departs} from: {$this->departureAirport->location->name} - Arrives {$arrives} at: {$this->arrivalAirport->location->name} ";
    }
